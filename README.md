...
![alt](https://img.shields.io/github/contributors/Shyroe/appointments-app.svg?style=flat&color=orange)
![alt](https://img.shields.io/github/forks/Shyroe/appointments-app.svg?color=orange)
...
- Create Modal component to make Insert, Update and Delete appointments
- Login Form and Input mask to create appointments Form
...
_git clone https://github.com/Shyroe/appointments-app.git_
...
**Answer**: React; Typescript; Json Server Fake API; Styled-components;
